...
✔️ [0107] Stats Section(통계) 클릭 시 팝업 형태로 상세 정보 제공

### all/page.tsx

~~💡 [0106] 지난 일/진행 중 분리~~

✔️ [0106] 지난 일/진행 중 분리 완료

### Header.tsx

💡 [0106] 알림 기능 검토

- 급한 일이 존재할 경우 알림 아이콘 활성화(불 들어온 상태)
- “급한 일” 전용 페이지 또는 필터 여부 검토
- 알림 클릭 시 급한 일 목록으로 이동

💬 [0107] 개인 설정한 기한 & priority에 해당하는 투두 표시
