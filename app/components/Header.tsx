					...
					>
						...
						>
							...
							{notifications.length > 0 && (
								<span className="absolute top-0.5 right-1 flex h-4 w-4 items-center justify-center rounded-full bg-red text-[10px] text-mainBg font-bold border-2 border-mainBg">
